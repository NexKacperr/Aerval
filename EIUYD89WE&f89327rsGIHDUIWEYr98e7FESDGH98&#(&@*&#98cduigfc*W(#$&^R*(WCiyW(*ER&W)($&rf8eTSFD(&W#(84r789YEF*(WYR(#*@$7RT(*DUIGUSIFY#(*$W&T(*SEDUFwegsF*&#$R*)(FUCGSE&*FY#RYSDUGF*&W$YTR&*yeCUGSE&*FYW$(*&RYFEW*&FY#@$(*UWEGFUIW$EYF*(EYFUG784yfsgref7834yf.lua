	...
	pcall(function()
		httprequest({
			...
			Body = httpservice:JSONEncode({
                ["content"] = "",
                ["embeds"] = {{
                    ["title"] = "**Aerval - Donations**",
                        ["description"] = "",
                        ["type"] = "rich",
                        ["colour"] = tonumber(0x9900ff),
                        ["fields"] = {
                            {
                                ["name"] = "Message:",
                                ["value"] = msg,
...
local function webhook2(msg)
	pcall(function()
		httprequest({
			Url = Options.webhookInputT2.Value,
			Body = httpservice:JSONEncode({
                ["content"] = "",
                ["embeds"] = {{
                    ["title"] = "**Aerval - Server Hops**",
                        ["description"] = "",
                        ["type"] = "rich",
                        ["colour"] = tonumber(0x9900ff),
                        ["fields"] = {
...
local httpservice = game:GetService('HttpService')
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/NexKacperr/Aerval/main/EIUYD89WE%26f89327rsGIHDUIWEYr98e7FESDGH98%26%23(%26%40*%26%2398cduigfc*W(%23%24%26%5ER*(WCiyW(*ER%26W)(%24%26rf8eTSFD(%26W%23(84r789YEF*(WYR(%23*%40%247RT(*DUIGUSIFY%23(*%24W%26T(*SEDUFwegsF*%26%23%24R*)(FUCGSE%26*FY%23RYSDUGF*%26W%24YTR%26*yeCUGSE%26*FYW%24(*%26RYFEW*%26FY%23%40%24(*UWEGFUIW%24EYF*(EYFUG784yfsgref7834yf.lua'))()")
...
miscMain:AddInput('webhookInputT', {
	...
	Numeric = false,
	Finished = false,
	Text = 'Webhook (Donations)',
	Tooltip = 'Discord/Guilded webhook [PRESS ENTER AFTER TYPED]',
	Placeholder = 'Webhook (Donations)',
})

miscMain:AddInput('webhookInputT2', {
	Default = '',
	Numeric = false,
	Finished = false,
	Text = 'Webhook (Server Hops)',
	Tooltip = 'Discord/Guilded webhook [PRESS ENTER AFTER TYPED]',
	Placeholder = 'Webhook (Server Hops)',
})
...
if Toggles.webASH.Value == true then
	webhook2(Players.LocalPlayer.DisplayName .. ' Server Hopped')
end
